...
def alta():
    ...
    aux=str(ape.lower())+","+str(nom.lower())+","+str(dni)+","+str(gen)+","+str(fecha)+","+str(nm_usr)+","+str(contra)+","+str(num_t)+","+str(saldo)+"\n"
    archivo=open("sube_datos.txt","a")
    archivo.write(aux)
    archivo.close()
    menu()
    ...
    while lee!='':
        ...
        if str(lee_aux[0])!=str('X'):
            if veri != int(lee_aux[7]):
                ...
                num_t=lee_aux[7]
                print("su numero de tarjeta es",num_t)
                aux2=str(ape.lower())+","+str(nom.lower())+","+str(dni)+","+str(gen)+","+str(fecha)+","+str(nm_usr)+","+str(contra)+","+str(num_t)+","+str(saldo)+"\n"
                aux.write(aux2)
            lee = archivo.readline()
